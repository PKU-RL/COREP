...
def get_args(rest_args):
    ...
    parser.add_argument('--exp_label', default='COREP', help='label (typically name of method)')
    parser.add_argument('--env_name', default='cartpole-swingup', help='environment to train on')
    ...
    parser.add_argument('--latent_dim', type=int, default=4, help='dimensionality of latent space')
    ...
    # - decoder: ground-truth task ("COREP oracle", after Humplik et al. 2019)
    ...
    parser.add_argument('--td_buffer_size', type=int, default=20000)
    parser.add_argument('--td_recent_size', type=float, default=0.1)
    parser.add_argument('--confidence', type=float, default=1.96)
    parser.add_argument('--freeze_eps', type=float, default=0.05)

    parser.add_argument('--graph_loss_coeff', type=float, default=0.1)
    parser.add_argument('--sparsity_loss_coeff', type=float, default=0.001)
    parser.add_argument('--mag_loss_coeff', type=float, default=0.001)
