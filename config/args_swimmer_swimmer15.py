...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='swimmer-swimmer15', help='environment to train on')
    ...
    parser.add_argument('--latent_dim', type=int, default=8, help='dimensionality of latent space')
